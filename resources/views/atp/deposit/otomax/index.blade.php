<x-app-layout menuActive="otomax">
    ...
    @section('breadcrumb')
    <div class="col-sm-6">
        <h1 class="m-0">DATA DEPOSIT OTOMAX</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
    ...
    <div class="container-fluid">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete{{ $value->id }}" action="{{ route('atp.deposit.otomax.destroy', ['id' => $value->id]) }}" style="display: inline-block;" method="POST">
                                                    @csrf
                                                    @method('delete')
        ...
        <div class="row mt-1">
            <div class="col-3">
                <a href="{{ route('atp.deposit.otomax.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                    DEPOSIT OTOMAX</a>
            </div>
        </div>
    </div>
