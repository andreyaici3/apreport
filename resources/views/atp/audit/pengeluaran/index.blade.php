<x-app-layout menuActive="auditpengeluaran" menuOpen="audit">

    @section('breadcrumb')
        <div class="col-sm-6">
            <h1 class="m-0">DATA AUDIT PENGELUARAN</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Data Audit Pengeluaran</li>
            </ol>
        </div><!-- /.col -->
    @endsection
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="delete{{ $value->id }}"
                                                        action="{{ route('atp.audit.destroy', ['id_mutasi' => $value->id, 'type' => 'pengeluaran']) }}"
