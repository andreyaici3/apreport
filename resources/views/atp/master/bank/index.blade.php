<x-app-layout menuActive="bank">
    ...
    <div class="container-fluid">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('atp.bank.edit', ['id' => $value->id]) }}" class="btn btn-xs btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                    Edit
                                                </a>|
                                                <form id="delete{{ $value->id }}" action="{{ route('atp.bank.delete', ['id' => $value->id]) }}" style="display: inline-block;" method="POST">
                                                    @csrf
                                                    @method('delete')
        ...
        <div class="row mt-1">
            <div class="col-3">
                <a href="{{ route('atp.bank.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                    CREATE</a>
            </div>
        </div>
    </div>
